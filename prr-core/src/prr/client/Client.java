...
public class Client implements Serializable, Comparable<Client>{ /**
	...
	public final static Comparator<Client> DEBT_COMPARATOR = new DebtComparator();

	public final static Comparator<Client> ID_COMPARATOR = new IDcomparator();

	private static class IDcomparator implements Comparator<Client> {
	...
	private static class DebtComparator implements Comparator<Client> {
		...
		public int compare(Client o1, Client o2) {
			...
			return Collator.getInstance().compare(o1._key, o2._key);
		}
	}
