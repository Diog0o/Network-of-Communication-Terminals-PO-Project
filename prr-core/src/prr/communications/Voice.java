...
public class Voice extends Communication {
	...
	private  double _voiceminutes;
	
	public Voice(int id, long cost, Terminal tin, Terminal tout, double minutes){
	...
	public double get_voiceminutes() {
	...
	public String toString(){
		...
		return "VOICE" + "|" + this.get_id() + "|" + this.get_terminalSender().get_key() + "|" + this.get_terminalReceiver().get_key() + "|" + Math.round(_voiceminutes) + "|" + this.get_cost() + "|" + this.ShowCommunicationStatus();
	}
